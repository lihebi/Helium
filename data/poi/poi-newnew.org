...
| nstx-1.1-beta3            | nstxd.c               |   121 | stmt | null-deref     | pkt = 0                               | dns_free(pkt);            |
...
| gzip-1.2.4                | gzip.c                |  1009 | stmt |                | strlen(iname) > sizeof(ifname)        |                           |
| ncompress                 | compress42.c          |   892 | stmt |                |                                       |                           |
| ncompress-4.2.4           | compress42.c          |   886 | stmt |                | strlen(fileptr[0]) > sizeof(tempname) |                           |
| polymorph-0.4.0           | polymorph.c           |   118 | stmt |                | strlen(optarg) > sizeof(target)       |                           |
