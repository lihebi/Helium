...
/**
 * HEBI's Coding Stardards
 * 1. ToString(): return a string description, for HUMAN READ
 * 2. Dump(): prints out some string for HUMAN to understand the class, but returns nothing.
 */
